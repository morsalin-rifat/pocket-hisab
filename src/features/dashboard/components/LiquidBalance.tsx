...
export const LiquidBalance = ({ percentage = 75, amount = "12,500.00" }) => {
  return (
    <div className="relative w-full h-[220px] rounded-[48px] bg-black overflow-hidden mb-12 border border-white/10 shadow-2xl">
      ...
      >
        {/* ঢেউগুলো এখন পানির রঙের সাথে ১০০% ম্যাচ করা */}
        <div className="absolute top-0 left-0 w-[400%] h-24 -translate-y-[98%] flex">
          ...
          <svg viewBox="0 0 1200 120" className="w-1/2 h-full wave-layer fill-cyan-500 opacity-80" style={{ animationDuration: '7s', animationDirection: 'reverse', top: '-2px' }}>
      ...
      {/* গ্লাস শাইন (শুধু গ্লাসের ফিল দেওয়ার জন্য) */}
